...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the 10-minute memory extraction cron task.")
    ...
    result = runner.run_memory_extraction(window_minutes=args.window_minutes)
    json.dump(
        {
