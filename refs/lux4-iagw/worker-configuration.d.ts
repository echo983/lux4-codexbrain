/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b6eff279a80152f5a808b99d52a09a11)
...
declare namespace Cloudflare {
	...
	interface Env {
		QUEUE_LUX4_REPLY: Queue;
		VPC_SERVICE: Fetcher;
		AI: Ai;
		CHAT_WORKFLOW: Workflow<Parameters<import("./src/index").ChatWorkflow['run']>[0]['payload']>;
	}
}
